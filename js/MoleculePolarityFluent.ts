...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustSlider', 'a11y.common.keyboardHelpContent.adjustSliderStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustSliderDescription', 'a11y.common.keyboardHelpContent.adjustSliderDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustInSmallerSteps', 'a11y.common.keyboardHelpContent.adjustInSmallerStepsStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustInSmallerStepsDescription', 'a11y.common.keyboardHelpContent.adjustInSmallerStepsDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustInLargerSteps', 'a11y.common.keyboardHelpContent.adjustInLargerStepsStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_adjustInLargerStepsDescription', 'a11y.common.keyboardHelpContent.adjustInLargerStepsDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_jumpToMinimum', 'a11y.common.keyboardHelpContent.jumpToMinimumStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_jumpToMinimumDescription', 'a11y.common.keyboardHelpContent.jumpToMinimumDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_jumpToMaximum', 'a11y.common.keyboardHelpContent.jumpToMaximumStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_jumpToMaximumDescription', 'a11y.common.keyboardHelpContent.jumpToMaximumDescriptionStringProperty' );
...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_moveAtomAAndCDescription', 'a11y.common.keyboardHelpContent.moveAtomAAndCDescriptionStringProperty' );
...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_rotateOrMoveInSmallerStepsDescription', 'a11y.common.keyboardHelpContent.rotateOrMoveInSmallerStepsDescriptionStringProperty' );
...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_showMolecules', 'a11y.common.keyboardHelpContent.showMoleculesStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_showMoleculesDescription', 'a11y.common.keyboardHelpContent.showMoleculesDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_moveThroughMolecules', 'a11y.common.keyboardHelpContent.moveThroughMoleculesStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_moveThroughMoleculesDescription', 'a11y.common.keyboardHelpContent.moveThroughMoleculesDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_changeMolecule', 'a11y.common.keyboardHelpContent.changeMoleculeStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_changeMoleculeDescription', 'a11y.common.keyboardHelpContent.changeMoleculeDescriptionStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_closeWithoutChanging', 'a11y.common.keyboardHelpContent.closeWithoutChangingStringProperty' );
addToMapIfDefined( 'a11y_common_keyboardHelpContent_closeWithoutChangingDescription', 'a11y.common.keyboardHelpContent.closeWithoutChangingDescriptionStringProperty' );
...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_rotateMoleculeWASDDescription', 'a11y.common.keyboardHelpContent.rotateMoleculeWASDDescriptionStringProperty' );
...
addToMapIfDefined( 'a11y_common_keyboardHelpContent_rotateInSmallerStepsWASDDescription', 'a11y.common.keyboardHelpContent.rotateInSmallerStepsWASDDescriptionStringProperty' );
  ...
  a11y: {
    common: {
      ...
      keyboardHelpContent: {
        ...
        adjustSliderStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustSlider', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustSliderStringProperty' ) ),
        adjustSliderDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustSliderDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustSliderDescriptionStringProperty' ) ),
        adjustInSmallerStepsStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustInSmallerSteps', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustInSmallerStepsStringProperty' ) ),
        adjustInSmallerStepsDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustInSmallerStepsDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustInSmallerStepsDescriptionStringProperty' ) ),
        adjustInLargerStepsStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustInLargerSteps', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustInLargerStepsStringProperty' ) ),
        adjustInLargerStepsDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_adjustInLargerStepsDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.adjustInLargerStepsDescriptionStringProperty' ) ),
        jumpToMinimumStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_jumpToMinimum', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.jumpToMinimumStringProperty' ) ),
        jumpToMinimumDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_jumpToMinimumDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.jumpToMinimumDescriptionStringProperty' ) ),
        jumpToMaximumStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_jumpToMaximum', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.jumpToMaximumStringProperty' ) ),
        jumpToMaximumDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_jumpToMaximumDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.jumpToMaximumDescriptionStringProperty' ) ),
        ...
        moveAtomAAndCDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_moveAtomAAndCDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.moveAtomAAndCDescriptionStringProperty' ) ),
        ...
        rotateOrMoveInSmallerStepsDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_rotateOrMoveInSmallerStepsDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.rotateOrMoveInSmallerStepsDescriptionStringProperty' ) ),
        ...
        showMoleculesStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_showMolecules', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.showMoleculesStringProperty' ) ),
        showMoleculesDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_showMoleculesDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.showMoleculesDescriptionStringProperty' ) ),
        moveThroughMoleculesStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_moveThroughMolecules', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.moveThroughMoleculesStringProperty' ) ),
        moveThroughMoleculesDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_moveThroughMoleculesDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.moveThroughMoleculesDescriptionStringProperty' ) ),
        changeMoleculeStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_changeMolecule', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.changeMoleculeStringProperty' ) ),
        changeMoleculeDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_changeMoleculeDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.changeMoleculeDescriptionStringProperty' ) ),
        closeWithoutChangingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_closeWithoutChanging', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.closeWithoutChangingStringProperty' ) ),
        closeWithoutChangingDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_closeWithoutChangingDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.closeWithoutChangingDescriptionStringProperty' ) ),
        ...
        rotateMoleculeWASDDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_rotateMoleculeWASDDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.rotateMoleculeWASDDescriptionStringProperty' ) ),
        ...
        rotateInSmallerStepsWASDDescriptionStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_keyboardHelpContent_rotateInSmallerStepsWASDDescription', _.get( MoleculePolarityStrings, 'a11y.common.keyboardHelpContent.rotateInSmallerStepsWASDDescriptionStringProperty' ) )
      }
    },
    _comment_0: new FluentComment( {"comment":"===================","associatedKey":"bondCharacter"} ),
    _comment_1: new FluentComment( {"comment":"REGIONS / PARAMETERS","associatedKey":"bondCharacter"} ),
    ...
    _comment_12: new FluentComment( {"comment":"ElectronDensityProgress2 - Electron Density Progress (Screen 1)","associatedKey":"electronDensityProgressUppercase"} ),
    ...
    _comment_14: new FluentComment( {"comment":"ElectroPotential6 - Electrostatic Potential (Screen 1)","associatedKey":"electrostaticPotentialUppercase"} ),
    ...
    _comment_19: new FluentComment( {"comment":"ElectroPotentialRegions5","associatedKey":"electrostaticRegions"} ),
    ...
    _comment_20: new FluentComment( {"comment":"EN6 - Electronegativity levels (Screen 1/2)","associatedKey":"electronegativity"} ),
    ...
    _comment_21: new FluentComment( {"comment":"Field2 - Electric Field state (Screen 1/2)","associatedKey":"field"} ),
    ...
    _comment_22: new FluentComment( {"comment":"MolecularDipole11 - Molecular Dipole magnitude (Screen 2)","associatedKey":"molecularDipole"} ),
    ...
    _comment_24: new FluentComment( {"comment":"OrientationMol3 - Molecule orientation (Screen 1)","associatedKey":"orientationMolecule"} ),
    ...
    _comment_25: new FluentComment( {"comment":"PartialCharge2 - Partial Charge sign (Screen 1/2)","associatedKey":"partialChargeSign"} ),
    ...
    _comment_26: new FluentComment( {"comment":"Polarity6 - Bond Polarity (Screen 1/2)","associatedKey":"polarity"} ),
    ...
    _comment_27: new FluentComment( {"comment":"PartialCharge11 - Partial Charge magnitude (Screen 1)","associatedKey":"partialChargeMagnitude"} ),
    ...
    _comment_28: new FluentComment( {"comment":"bondDipole6 - Bond Dipole magnitude (Screen 1)","associatedKey":"bondDipole"} ),
    ...
    _comment_29: new FluentComment( {"comment":"Rotation2 - Rotation direction (Screen 1/2)","associatedKey":"rotation"} ),
    ...
    _comment_30: new FluentComment( {"comment":"Shape7 - Molecule shape (Screen 2)","associatedKey":"shape"} ),
    ...
    _comment_34: new FluentComment( {"comment":"===================","associatedKey":"threeAtomsScreen"} ),
    _comment_35: new FluentComment( {"comment":"THREE ATOMS SCREEN","associatedKey":"threeAtomsScreen"} ),
    _comment_36: new FluentComment( {"comment":"===================","associatedKey":"threeAtomsScreen"} ),
    threeAtomsScreen: {
      _comment_0: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_1: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_2: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
    ...
    realMoleculesScreen: {
      ...
      moleculesComboBox: {
        accessibleName: new FluentPattern<{ moleculeName: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesComboBox_accessibleName', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesComboBox.accessibleNameStringProperty' ), [{"name":"moleculeName"}] ),
        accessibleHelpTextStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesComboBox_accessibleHelpText', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesComboBox.accessibleHelpTextStringProperty' ) )
      },
      molecules: {
        description: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_description', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.descriptionStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        _comment_0: new FluentComment( {"comment":"bondDipole6 - Bond Dipole magnitude (Screen 1)","associatedKey":"bondDipole"} ),
        bondDipole: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_bondDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.bondDipoleStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        _comment_1: new FluentComment( {"comment":"MolecularDipole11 - Molecular Dipole magnitude (Screen 2)","associatedKey":"molecularDipole"} ),
        molecularDipole: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_molecularDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.molecularDipoleStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        partialCharges: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_partialCharges', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.partialChargesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        _comment_2: new FluentComment( {"comment":"EN6 - Electronegativity levels (Screen 1/2)","associatedKey":"electronegativity"} ),
        electronegativity: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronegativity', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronegativityStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        ...
        electrostaticPotential: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotentialStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] ),
        _comment_4: new FluentComment( {"comment":"ElectronDensity6 - Electron Density (Screen 1)","associatedKey":"electronDensity"} ),
        electronDensity: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensityStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","tetrafluoromethane","chloroform"]}] )
      }
    }
  }
};
