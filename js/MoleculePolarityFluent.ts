...
const MoleculePolarityFluent = {
  ...
  _comment_4: new FluentComment( {"comment":"MolecularDipole11 - Molecular Dipole magnitude (Screen 2)","associatedKey":"molecularDipole"} ),
  molecularDipoleStringProperty: _.get( MoleculePolarityStrings, 'molecularDipoleStringProperty' ),
  _comment_5: new FluentComment( {"comment":"EN6 - Electronegativity levels (Screen 1/2)","associatedKey":"electronegativity"} ),
  ...
  _comment_6: new FluentComment( {"comment":"ElectroPotential6 - Electrostatic Potential (Screen 1)","associatedKey":"electrostaticPotential"} ),
  ...
  a11y: {
    ...
    _comment_26: new FluentComment( {"comment":"PartialCharge11 - Partial Charge magnitude (Screen 1/2)","associatedKey":"partialChargeMagnitude"} ),
    ...
    threeAtomsScreen: {
      ...
      moleculeABC: {
        ...
        bondDipoleABDescription: new FluentPattern<{ atom: FluentVariable, magnitude: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_threeAtomsScreen_moleculeABC_bondDipoleABDescription', _.get( MoleculePolarityStrings, 'a11y.threeAtomsScreen.moleculeABC.bondDipoleABDescriptionStringProperty' ), [{"name":"atom"},{"name":"magnitude"}] ),
        ...
        bondDipoleBCDescription: new FluentPattern<{ atom: FluentVariable, magnitude: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_threeAtomsScreen_moleculeABC_bondDipoleBCDescription', _.get( MoleculePolarityStrings, 'a11y.threeAtomsScreen.moleculeABC.bondDipoleBCDescriptionStringProperty' ), [{"name":"atom"},{"name":"magnitude"}] ),
