...
addToMapIfDefined( 'a11y_common_electronegativitySlider_dipoleContextTwoBonds', 'a11y.common.electronegativitySlider.dipoleContextTwoBondsStringProperty' );
...
addToMapIfDefined( 'a11y_common_surfaceRadioButtonGroup_accessibleHeading', 'a11y.common.surfaceRadioButtonGroup.accessibleHeadingStringProperty' );
...
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_bondDipole_noBondDipole', 'a11y.realMoleculesScreen.molecules.bondDipole.noBondDipoleStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_bondDipole_verySmallCarbonHydrogen', 'a11y.realMoleculesScreen.molecules.bondDipole.verySmallCarbonHydrogenStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_bondDipole_selectMolecules', 'a11y.realMoleculesScreen.molecules.bondDipole.selectMoleculesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_invertedBondDipole_noBondDipole', 'a11y.realMoleculesScreen.molecules.invertedBondDipole.noBondDipoleStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_invertedBondDipole_verySmallCarbonHydrogen', 'a11y.realMoleculesScreen.molecules.invertedBondDipole.verySmallCarbonHydrogenStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_invertedBondDipole_selectMolecules', 'a11y.realMoleculesScreen.molecules.invertedBondDipole.selectMoleculesStringProperty' );
...
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electrostaticPotential_veryLargeElectrostaticPotential', 'a11y.realMoleculesScreen.molecules.electrostaticPotential.veryLargeElectrostaticPotentialStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electrostaticPotential_mediumElectrostaticPotentialDifference', 'a11y.realMoleculesScreen.molecules.electrostaticPotential.mediumElectrostaticPotentialDifferenceStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electrostaticPotential_largeElectrostaticPotentialDifference', 'a11y.realMoleculesScreen.molecules.electrostaticPotential.largeElectrostaticPotentialDifferenceStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electrostaticPotential_selectMolecules', 'a11y.realMoleculesScreen.molecules.electrostaticPotential.selectMoleculesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenly', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlyStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlyShared', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityEvenlyShared', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityEvenlySharedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlySharedShifted', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedShiftedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlySharedShiftedFluorines', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedShiftedFluorinesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityUnevenlyShared', 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityUnevenlySharedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_molecules_electronDensity_selectMolecules', 'a11y.realMoleculesScreen.molecules.electronDensity.selectMoleculesStringProperty' );
...
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_bondDipole_noBondDipole', 'a11y.realMoleculesScreen.moleculesAdvanced.bondDipole.noBondDipoleStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_bondDipole_selectMolecules', 'a11y.realMoleculesScreen.moleculesAdvanced.bondDipole.selectMoleculesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_invertedBondDipole_noBondDipole', 'a11y.realMoleculesScreen.moleculesAdvanced.invertedBondDipole.noBondDipoleStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_invertedBondDipole_selectMolecules', 'a11y.realMoleculesScreen.moleculesAdvanced.invertedBondDipole.selectMoleculesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_molecularDipole_largeMolecularDipolePointing', 'a11y.realMoleculesScreen.moleculesAdvanced.molecularDipole.largeMolecularDipolePointingStringProperty' );
...
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_largeElectrostaticPotentialDifference', 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.largeElectrostaticPotentialDifferenceStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_smallElectrostaticPotentialDifference', 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.smallElectrostaticPotentialDifferenceStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_selectMolecules', 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.selectMoleculesStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_partialCharges_noPartialCharges', 'a11y.realMoleculesScreen.moleculesAdvanced.partialCharges.noPartialChargesStringProperty' );
...
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityConcentratedAtoms', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityConcentratedAtomsStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityEvenlyShared', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityEvenlySharedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityVeryUnevenly', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityVeryUnevenlyStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityUnevenlyShared', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityUnevenlySharedStringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityUnevenlyShared1', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityUnevenlyShared1StringProperty' );
addToMapIfDefined( 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_selectMolecules', 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.selectMoleculesStringProperty' );
...
const MoleculePolarityFluent = {
  ...
  _comment_9: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"hydrogen"} ),
  ...
  a11y: {
    common: {
      ...
      electronegativitySlider: {
        ...
        _comment_2: new FluentComment( {"comment":"The context response for dipole direction change when there are two bonds. The information is combined","associatedKey":"dipoleDirectionChangeTwoBonds"} ),
      ...
      surfaceRadioButtonGroup: {
        accessibleHeadingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_surfaceRadioButtonGroup_accessibleHeading', _.get( MoleculePolarityStrings, 'a11y.common.surfaceRadioButtonGroup.accessibleHeadingStringProperty' ) ),
    ...
    _comment_9: new FluentComment( {"comment":"ElectroPotential6 - Electrostatic Potential (Screen 1)","associatedKey":"electrostaticPotentialUppercase"} ),
    ...
    _comment_10: new FluentComment( {"comment":"ElectroPotentialRegions5","associatedKey":"electrostaticRegions"} ),
    ...
    _comment_11: new FluentComment( {"comment":"Electronegativity description","associatedKey":"electronegativity"} ),
    ...
    _comment_14: new FluentComment( {"comment":"MolecularDipole11 - Molecular Dipole magnitude (Screen 2)","associatedKey":"molecularDipole"} ),
    ...
    _comment_15: new FluentComment( {"comment":"OrientationMol3 - Molecule orientation (Screen 1)","associatedKey":"orientationMolecule"} ),
    ...
    _comment_16: new FluentComment( {"comment":"PartialCharge2 - Partial Charge sign (Screen 1/2)","associatedKey":"partialChargeSign"} ),
    ...
    _comment_17: new FluentComment( {"comment":"Polarity6 - Bond Polarity (Screen 1/2)","associatedKey":"polarity"} ),
    ...
    _comment_18: new FluentComment( {"comment":"PartialCharge11 - Partial Charge magnitude (Screen 1)","associatedKey":"partialChargeMagnitude"} ),
    ...
    _comment_19: new FluentComment( {"comment":"bondDipole6 - Bond Dipole magnitude (Screen 1)","associatedKey":"bondDipole"} ),
    ...
    _comment_20: new FluentComment( {"comment":"Rotation2 - Rotation direction (Screen 1/2)","associatedKey":"rotation"} ),
    ...
    _comment_21: new FluentComment( {"comment":"Shape7 - Molecule shape (Screen 2)","associatedKey":"shape"} ),
    ...
    _comment_22: new FluentComment( {"comment":"===================","associatedKey":"twoAtomsScreen"} ),
    _comment_23: new FluentComment( {"comment":"TWO ATOMS SCREEN","associatedKey":"twoAtomsScreen"} ),
    _comment_24: new FluentComment( {"comment":"===================","associatedKey":"twoAtomsScreen"} ),
    twoAtomsScreen: {
    ...
    _comment_25: new FluentComment( {"comment":"===================","associatedKey":"threeAtomsScreen"} ),
    _comment_26: new FluentComment( {"comment":"THREE ATOMS SCREEN","associatedKey":"threeAtomsScreen"} ),
    _comment_27: new FluentComment( {"comment":"===================","associatedKey":"threeAtomsScreen"} ),
    threeAtomsScreen: {
      _comment_0: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_1: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_2: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
    ...
    _comment_28: new FluentComment( {"comment":"===================","associatedKey":"realMoleculesScreen"} ),
    _comment_29: new FluentComment( {"comment":"REAL MOLECULES SCREEN","associatedKey":"realMoleculesScreen"} ),
    _comment_30: new FluentComment( {"comment":"===================","associatedKey":"realMoleculesScreen"} ),
    realMoleculesScreen: {
      _comment_0: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_1: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      _comment_2: new FluentComment( {"comment":"Screen Summary","associatedKey":"screenSummary"} ),
      ...
      molecules: {
        ...
        bondDipole: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_1: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_2: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_3: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          noBondDipoleStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_bondDipole_noBondDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.bondDipole.noBondDipoleStringProperty' ) ),
          verySmallCarbonHydrogenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_bondDipole_verySmallCarbonHydrogen', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.bondDipole.verySmallCarbonHydrogenStringProperty' ) ),
          ...
          _comment_7: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_8: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_9: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_10: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_bondDipole_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.bondDipole.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        },
        invertedBondDipole: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_1: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_2: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_3: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          noBondDipoleStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_invertedBondDipole_noBondDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.invertedBondDipole.noBondDipoleStringProperty' ) ),
          verySmallCarbonHydrogenStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_invertedBondDipole_verySmallCarbonHydrogen', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.invertedBondDipole.verySmallCarbonHydrogenStringProperty' ) ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_6: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_7: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
        ...
        electrostaticPotential: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noElectrostaticPotentialDifference"} ),
          noElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential_noElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotential.noElectrostaticPotentialDifferenceStringProperty' ) ),
          veryLargeElectrostaticPotentialStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential_veryLargeElectrostaticPotential', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotential.veryLargeElectrostaticPotentialStringProperty' ) ),
          _comment_1: new FluentComment( {"comment":"Generic descriptions","associatedKey":"mediumElectrostaticPotentialDifference"} ),
          mediumElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential_mediumElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotential.mediumElectrostaticPotentialDifferenceStringProperty' ) ),
          largeElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential_largeElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotential.largeElectrostaticPotentialDifferenceStringProperty' ) ),
          _comment_2: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_3: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_12: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_13: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electrostaticPotential_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electrostaticPotential.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        },
        _comment_2: new FluentComment( {"comment":"ElectronDensity6 - Electron Density (Screen 1)","associatedKey":"electronDensity"} ),
        electronDensity: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"electronDensityVeryUnevenly"} ),
          electronDensityVeryUnevenlyStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenly', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlyStringProperty' ) ),
          electronDensityVeryUnevenlySharedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlyShared', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedStringProperty' ) ),
          electronDensityEvenlySharedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityEvenlyShared', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityEvenlySharedStringProperty' ) ),
          electronDensityVeryUnevenlySharedShiftedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlySharedShifted', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedShiftedStringProperty' ) ),
          electronDensityVeryUnevenlySharedShiftedFluorinesStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityVeryUnevenlySharedShiftedFluorines', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityVeryUnevenlySharedShiftedFluorinesStringProperty' ) ),
          electronDensityUnevenlySharedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_electronDensityUnevenlyShared', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.electronDensityUnevenlySharedStringProperty' ) ),
          _comment_1: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_2: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_3: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_11: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_12: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_molecules_electronDensity_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.molecules.electronDensity.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        }
      },
      moleculesAdvanced: {
        ...
        bondDipole: {
          ...
          _comment_2: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_3: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          noBondDipoleStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_bondDipole_noBondDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.bondDipole.noBondDipoleStringProperty' ) ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_6: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_7: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_14: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_15: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_bondDipole_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.bondDipole.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        },
        invertedBondDipole: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_1: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_2: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          _comment_3: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noBondDipole"} ),
          noBondDipoleStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_invertedBondDipole_noBondDipole', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.invertedBondDipole.noBondDipoleStringProperty' ) ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_6: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_7: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_14: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_15: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_invertedBondDipole_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.invertedBondDipole.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        },
        _comment_1: new FluentComment( {"comment":"MolecularDipole11 - Molecular Dipole magnitude (Screen 2)","associatedKey":"molecularDipole"} ),
        molecularDipole: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"largeMolecularDipolePointing"} ),
        ...
        electrostaticPotential: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"mediumElectrostaticPotentialDifference"} ),
          mediumElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_mediumElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.mediumElectrostaticPotentialDifferenceStringProperty' ) ),
          largeElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_largeElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.largeElectrostaticPotentialDifferenceStringProperty' ) ),
          smallElectrostaticPotentialDifferenceStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_smallElectrostaticPotentialDifference', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.smallElectrostaticPotentialDifferenceStringProperty' ) ),
          _comment_1: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_2: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_3: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_11: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_12: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electrostaticPotential_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electrostaticPotential.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        },
        partialCharges: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"noPartialCharges"} ),
          noPartialChargesStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_partialCharges_noPartialCharges', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.partialCharges.noPartialChargesStringProperty' ) ),
          _comment_1: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"hydrogen"} ),
        ...
        _comment_2: new FluentComment( {"comment":"ElectronDensity6 - Electron Density (Screen 1)","associatedKey":"electronDensity"} ),
        electronDensity: {
          _comment_0: new FluentComment( {"comment":"Generic descriptions","associatedKey":"electronDensityConcentratedAtoms"} ),
          electronDensityConcentratedAtomsStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityConcentratedAtoms', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityConcentratedAtomsStringProperty' ) ),
          electronDensityEvenlySharedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityEvenlyShared', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityEvenlySharedStringProperty' ) ),
          _comment_1: new FluentComment( {"comment":"Generic descriptions","associatedKey":"electronDensityVeryUnevenly"} ),
          electronDensityVeryUnevenlyStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityVeryUnevenly', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityVeryUnevenlyStringProperty' ) ),
          electronDensityUnevenlySharedStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityUnevenlyShared', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityUnevenlySharedStringProperty' ) ),
          electronDensityUnevenlyShared1StringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_electronDensityUnevenlyShared1', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.electronDensityUnevenlyShared1StringProperty' ) ),
          _comment_2: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_3: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_4: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_5: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          ...
          _comment_12: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          _comment_13: new FluentComment( {"comment":"Molecule descriptions. We add another level of nesting so the select_ pattern is an only child","associatedKey":"selectMolecules"} ),
          selectMolecules: new FluentPattern<{ molecule: 'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform' | TReadOnlyProperty<'hydrogen' | 'nitrogen' | 'oxygen' | 'fluorine' | 'hydrogenFluoride' | 'water' | 'carbonDioxide' | 'hydrogenCyanide' | 'ozone' | 'ammonia' | 'borane' | 'boronTrifluoride' | 'formaldehyde' | 'methane' | 'fluoromethane' | 'difluoromethane' | 'trifluoromethane' | 'tetrafluoromethane' | 'chloroform'> }>( fluentSupport.bundleProperty, 'a11y_realMoleculesScreen_moleculesAdvanced_electronDensity_selectMolecules', _.get( MoleculePolarityStrings, 'a11y.realMoleculesScreen.moleculesAdvanced.electronDensity.selectMoleculesStringProperty' ), [{"name":"molecule","variants":["hydrogen","nitrogen","oxygen","fluorine","hydrogenFluoride","water","carbonDioxide","hydrogenCyanide","ozone","ammonia","borane","boronTrifluoride","formaldehyde","methane","fluoromethane","difluoromethane","trifluoromethane","tetrafluoromethane","chloroform"]}] )
        }
      }
    }
  }
