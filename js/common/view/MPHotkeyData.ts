...
const MPHotkeyData = {
   ...
   */
  ROTATE_MOLECULE: new HotkeyData( {
   ...
   */
  ROTATE_MOLECULE_SMALLER_STEPS: new HotkeyData( {
    keys: [
   ...
   */
  ROTATE_MOLECULE_WASD: new HotkeyData( {
    keys: [
   ...
   */
  ROTATE_MOLECULE_WASD_SMALLER_STEPS: new HotkeyData( {
    keys: [
   ...
   */
  MOVE_ATOM_A_AND_C: new HotkeyData( {
    keys: [ 'arrowLeft', 'arrowRight', 'arrowUp', 'arrowDown' ],
   ...
   */
  ROTATE_OR_MOVE_SMALLER_STEPS: new HotkeyData( {
    keys: [
      'shift+arrowLeft', 'shift+arrowRight', 'shift+arrowUp', 'shift+arrowDown'
    ],
